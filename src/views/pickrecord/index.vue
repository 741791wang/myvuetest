  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      >
        ...
        <el-table-column align="center" label="采摘原料">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" label="采摘时间" width="160">
          <template slot-scope="scope">
            {{ scope.row.pickDate }}
          </template>
        </el-table-column>
...
import { getList } from '@/api/pickrecord'
  ...
  methods: {
    fetchdata() {
      getList({ pageNumber: this.listQuery.page, pageSize: this.listQuery.pageSize,
        name: this.listQuery.name, pickDate: this.datetime }).then(res => {
