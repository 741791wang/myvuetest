  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column align="center" label="上工工位">
          <template slot-scope="scope">
            {{ scope.row.stationName }}
          </template>
        </el-table-column>
        <el-table-column align="center" label="上工时间">
          <template slot-scope="scope">
            {{ scope.row.signinTime }}
          </template>
        </el-table-column>
        <el-table-column align="center" label="下工时间">
          <template slot-scope="scope">
...
import { getList } from '@/api/workmng'
  ...
  methods: {
    fetchdata() {
      getList({ pageNumber: this.listQuery.page, pageSize: this.listQuery.pageSize,
        employeeName: this.listQuery.name, startdate: this.datetime }).then(res => {
